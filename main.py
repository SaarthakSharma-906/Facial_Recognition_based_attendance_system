...
#         top_prediction_idx = np.argmax(probabilities[i])
#         top_prediction = idx_to_class[top_prediction_idx]
#         print(f"Top prediction: {top_prediction} with confidence {probabilities[i][top_prediction_idx]}")
#         print("All predictions:")
#         for label, prob in zip(idx_to_class, probabilities[i]):
#             print(f" - {label}: {prob}")



# if __name__ == '__main__':
#     image_path = r"C:\Users\Saarthak\Desktop\face_recognition\test_images\alejandro toledo.jpeg"  # Replace with your image path
#     model_path = r'C:\Users\Saarthak\Desktop\face_recognition\face_recogniser.pkl'  # Replace with your model path
...
if __name__ == '__main__':
    image_path = r"C:\Users\Saarthak\Desktop\face_recognition\test_images\rs_vk_rd.jpeg"  # Replace with your image path
    model_path = r'C:\Users\Saarthak\Desktop\face_recognition\face_recogniser.pkl'  # Replace with your model path
    main(image_path, model_path)
