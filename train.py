...
#     dataset_path = r"C:\Users\Saarthak\Desktop\face_recognition\data"
...
#     clf = LogisticRegression(multi_class='multinomial', C=10, max_iter=10000)
...
#     model_path = os.path.join(os.getcwd(), 'face_recogniser.pkl')
...
def filter_dataset(dataset, class_limit=5):
